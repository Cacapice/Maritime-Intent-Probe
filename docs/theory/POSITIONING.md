...
> [`docs/research_narrative.md`](docs/research_narrative.md), which is preserved as an
...
intent report strong held-out performance in recent work (for example, MacDiarmid
...
detection. The Construct-Validity Gate (**BC1 to BC11**) was developed for this
...
predictive-validity claims. The proposed identifiable designs (**V1 to V3**)
...
identifiability gate (**BC1 to BC11**) and an existence proof that standard
...
[`docs/research_narrative.md`](docs/research_narrative.md), with post-hoc changes
...
- Archival confirmatory record and current analytical plan, 
 [`docs/research_narrative.md`](docs/research_narrative.md)
