...
def main() -> int:
    ...
    from environment import (MaritimeEnvironment, EmbeddingGateway, ENCODING_VARIANTS,
                             audit_minimal_pairs)
    ...
    from experiment import ProbeExperiment, RunMode
    from transfer import run_transfer_matrix, run_held_out_template_analysis
    from bias_controls import (bc2_tokenisation_normalisation, bc3_pooling_comparison,
    ...
    from null_validator import (validate_null_control,
                                validate_encoding_variant_nulls,
                                lexical_parity_report)
    from monitor import DualLayerAuditMonitor
